...
#include "QuestSystemsModule/Public/Objective.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	QUESTSYSTEMSMODULE_API UEnum* Z_Construct_UEnum_QuestSystemsModule_EObjectiveType();
	...
	QUESTSYSTEMSMODULE_API UClass* Z_Construct_UClass_UObjective();
	COREUOBJECT_API UClass* Z_Construct_UClass_UObject();
	QUESTSYSTEMSMODULE_API UClass* Z_Construct_UClass_UInteractionObjective_NoRegister();
	QUESTSYSTEMSMODULE_API UClass* Z_Construct_UClass_UInteractionObjective();
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
	QUESTSYSTEMSMODULE_API UClass* Z_Construct_UClass_ULocationObjective_NoRegister();
	QUESTSYSTEMSMODULE_API UClass* Z_Construct_UClass_ULocationObjective();
// End Cross Module References
	static UEnum* EObjectiveType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_QuestSystemsModule_EObjectiveType, Z_Construct_UPackage__Script_QuestSystemsModule(), TEXT("EObjectiveType"));
		}
		return Singleton;
	}
	template<> QUESTSYSTEMSMODULE_API UEnum* StaticEnum<EObjectiveType>()
	{
		return EObjectiveType_StaticEnum();
	}
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EObjectiveType(EObjectiveType_StaticEnum, TEXT("/Script/QuestSystemsModule"), TEXT("EObjectiveType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_QuestSystemsModule_EObjectiveType_Hash() { return 740533887U; }
	UEnum* Z_Construct_UEnum_QuestSystemsModule_EObjectiveType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_QuestSystemsModule();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EObjectiveType"), 0, Get_Z_Construct_UEnum_QuestSystemsModule_EObjectiveType_Hash(), false);
#else
...
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UClass_UObjective_Statics::NewProp_Description = { "Description", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UObjective, Description), METADATA_PARAMS(Z_Construct_UClass_UObjective_Statics::NewProp_Description_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UObjective_Statics::NewProp_Description_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UObjective_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UObjective, Type), Z_Construct_UEnum_QuestSystemsModule_EObjectiveType, METADATA_PARAMS(Z_Construct_UClass_UObjective_Statics::NewProp_Type_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UObjective_Statics::NewProp_Type_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UObjective, 2800308964);
	template<> QUESTSYSTEMSMODULE_API UClass* StaticClass<UObjective>()
	{
		return UObjective::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UObjective(Z_Construct_UClass_UObjective, &UObjective::StaticClass, TEXT("/Script/QuestSystemsModule"), TEXT("UObjective"), false, nullptr, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(UInteractionObjective, 162029710);
	template<> QUESTSYSTEMSMODULE_API UClass* StaticClass<UInteractionObjective>()
	{
		return UInteractionObjective::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UInteractionObjective(Z_Construct_UClass_UInteractionObjective, &UInteractionObjective::StaticClass, TEXT("/Script/QuestSystemsModule"), TEXT("UInteractionObjective"), false, nullptr, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(ULocationObjective, 49294446);
	template<> QUESTSYSTEMSMODULE_API UClass* StaticClass<ULocationObjective>()
	{
		return ULocationObjective::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ULocationObjective(Z_Construct_UClass_ULocationObjective, &ULocationObjective::StaticClass, TEXT("/Script/QuestSystemsModule"), TEXT("ULocationObjective"), false, nullptr, nullptr, nullptr);
